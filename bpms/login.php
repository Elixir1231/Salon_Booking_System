...
?>
    ...
    <form method="post">
        <div>
            <input type="text" class="form-control" name="emailcont" required="true" placeholder="Registered Email or Contact Number">
        </div>
        ...
        <!-- Add this new section for Sign Up -->
        <div class="text-center" style="padding-top: 20px;">
            <p>Don't have an account? <a href="signup.php" style="color: blue;">Sign up here</a></p>
        </div>
    </form>
</div>
