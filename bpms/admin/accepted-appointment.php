    ...
    <div id="page-wrapper">
      <div class="main-page">
        <div class="tables">
          ...
          <!-- Search Bar -->
          <form method="GET" action="accepted-appointment.php" class="mb-4">
          ...
          <div class="table-responsive bs-example widget-shadow">
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                $searchQuery = "SELECT tbluser.FirstName, tbluser.LastName, tbluser.Email, tbluser.MobileNumber, tblbook.ID as bid, tblbook.AptNumber, tblbook.AptDate, tblbook.AptTime, tblbook.Message, tblbook.BookingDate, tblbook.Status 
                                FROM tblbook 
                                JOIN tbluser ON tbluser.ID = tblbook.UserID 
                                WHERE tblbook.Status = 'Selected'";

                if ($search) {
                    $searchQuery .= " AND (tblbook.AptNumber LIKE '%$search%' 
                                         OR tbluser.FirstName LIKE '%$search%' 
                                         OR tbluser.LastName LIKE '%$search%' 
                                         OR tbluser.MobileNumber LIKE '%$search%')";
                }

                $ret = mysqli_query($con, $searchQuery);
                $cnt = 1;
